...
<head>
    ...
    <title>Fourcreate | Personal Info</title>
...
<body style="background-color: #f0f0f0;">
    ...
    <div class="container">
        <div class="border bg-white">
            <div class="container">
                <a class="atasan" href="personal_info.php">Personal Info</a>
                    ...
                    <div class="col-9 my-5">
                        <div class="row">
                            <div class="col-12 mb-3 fw-semibold">
                                <label for="Title">Change Your Personal Info</label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col">
                                <input type="text" id="name" name="name" placeholder="Kelompok 1">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col">
                                <input type="text" id="address" name="address" placeholder="SMKN 4 Tangerang">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
                            ...
                            <div class="col">
                                <input type="text" id="phone" name="phone" placeholder="087878787888">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-2">
